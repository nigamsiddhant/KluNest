  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <LinearGradient colors={['#263755', '#1ABC9C']} style={styles.heading}>
        ...
        <Text style={styles.headingTxt}>  Payment History</Text>
      </LinearGradient>
      ...
      <View >
        ...
        <TouchableOpacity style={styles.PlanView} onPress={() => { navigation.navigate('StudentPayment'); }}>
          <Text style={styles.buyNowText}>Plan</Text>
        </TouchableOpacity>
      </View>
    </View>
  )
